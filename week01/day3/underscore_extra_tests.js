...
describe("memoize()", function() {
  ...
  it('if memoizedDouble() is called once with 1, then with 5, and then with 10, then double() is called once with 1, then with 5, and then with 10 and returns 2, 10 and 20 respectively', function() {
    expect(memoizedDouble(1)).toBe(2);
  ...
  it('if memoizedDouble() is called 3 times with 1, then with 5, and then with 10, then double() is called once with 1, then with 5, and then with 10 and returns 2, 10 and 20 respectively', function() {
    for (var i = 0; i < 3; i++) {
      expect(memoizedDouble(1)).toBe(2);
      expect(memoizedDouble(5)).toBe(10);
      expect(memoizedDouble(10)).toBe(20);
