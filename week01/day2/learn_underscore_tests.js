...
describe("learn_underscore.contains(item, array)", function() {
  ...
  it("learn_underscore.contains([], 'a') should call _.some()", function() {
...
describe("learn_underscore.some(array, fun)", function() {
  beforeEach(function() {
  ...
  it("learn_underscore.some([1], isTruthy) calls _.reduce()", function() {
    learn_underscore.some([1], isTruthy);
    expect(_.reduce).toHaveBeenCalled();
  });
  it("learn_underscore.some([], isTruthy) -> false", function() {
    expect(learn_underscore.some([], isTruthy) ).toBeFalsy();
  });
  it("learn_underscore.some([0, 0], isTruthy) -> false", function() {
    expect(learn_underscore.some([0, 0], isTruthy) ).toBe(false);
  });
  it("learn_underscore.some([0, 1, 0], isTruthy) -> true", function() {
    expect(learn_underscore.some([0, 1, 0], isTruthy) ).toBe(true);
  });
  it("learn_underscore.some([1], isTruthy) -> true", function() {
    expect(learn_underscore.some([1], isTruthy) ).toBe(true);
  });
  it("learn_underscore.some([1, 3, 5, 7], isEven) -> false", function() {
    expect(learn_underscore.some([1, 3, 5, 7], isEven)).toBe(false);
  });
  it("learn_underscore.some([1, 3, 5, 2, 7], isEven) -> true", function() {
    expect(learn_underscore.some([1, 3, 5, 7, 2], isEven)).toBe(true);
  });
  it("learn_underscore.some([40, 90, 1, 8, 20], isPrime) -> false", function() {
    expect(learn_underscore.some([40, 90, 1, 8, 20], isPrime)).toBe(false);
  });
  it("learn_underscore.some([40, 90, 1, 5, 8, 20], isPrime) -> true", function() {
    expect(learn_underscore.some([40, 90, 1, 5, 8, 20], isPrime)).toBe(true);
  });
});
