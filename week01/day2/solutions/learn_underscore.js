...
//  _.some([1], greaterThan1) -> true
//  _.some([0, 1], greaterThan1) -> true
...
learn_underscore.contains = function(array, item) {
  // YOUR CODE HERE
  return _.some(array, function(i) {
    return i === item;
  })
};
...
//
// Underscore function _.each() is similar to the Array.each() built-in function
