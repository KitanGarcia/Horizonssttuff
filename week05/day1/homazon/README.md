...
Let's exercise our ES6 skills by using Promises instead of callback functions in mongoose.

Mongoose async operations, like `.save()` and queries, return Promises. We can use Promises with mongoose like this:
